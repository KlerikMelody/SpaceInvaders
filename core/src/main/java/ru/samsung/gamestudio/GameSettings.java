...
public class GameSettings {
    ...
    public static float TRASH_VELOCITY = 10;
    ...
    public static int SHOOTING_COOL_DOWN = 125; // in [ms] - milliseconds
    ...
    public static final int TRASH_WIDTH = 200;
    public static final int TRASH_HEIGHT = 180;
